...
@section('header')
    <section class="header-operation container-fluid animated fadeIn d-flex mb-2 align-items-baseline d-print-none"
        ...
        <p class="ms-2 ml-2 mb-0" id="datatable_info_stack"
           bp-section="page-subheading">{!! $crud->getSubheading() ?? '' !!}</p>
    </section>
@endsection
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $('#groupFilter').change(function() {
                ...
                var currentUrl = ajax_table.ajax.url();
                var newUrl = new URL(currentUrl);

                if (value) {
                    newUrl.searchParams.set('group', value);
                } else {
                    newUrl.searchParams.delete('group');
                }

                ajax_table.ajax.url(newUrl.toString()).load();
            });
        });
    </script>
@endsection
