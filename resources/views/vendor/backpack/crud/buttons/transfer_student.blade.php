@if ($crud->hasAccess('transferStudent'))
    <a href="javascript:void(0)" onclick="cloneEntry(this)" data-route="{{ url($crud->route.'/'.$entry->getKey().'/clone') }}" class="dropdown-item">
        <span>
        <i class="la la-redo me-2 text-primary">
        </i>
            Перевести студента
        </span>
    </a>
